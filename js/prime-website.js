...
function init() {
    try {
        ...
        chrome.runtime.sendMessage({ type: "getCheckoutData" }, (res) => {
            if (res) {
                console.log("Checkout data received:", res);
...
function setLocalStorageItem(key, value, prefix = 'PRIMES::', stringify = false) {
