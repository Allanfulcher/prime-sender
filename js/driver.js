...
const customizationObj = {
  ...
  steps: [
    ...
    {
      element: ".import_excel_box",
      popover: {
        title: "Click here",
        description:
        "Click here to import your excel file.",
        onNextClick: () => {
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          "You can now enter the custom column you'd like to send from the given option below",
      },
    },
    {
      element: ".message-box",
  ...
  steps: [
    {
      ...
      popover: {
        title: "Download saved or chat contacts",
        description:
          "Download saved contacts or chat contacts from your whatsapp account",
      },
    },
  ],
};
